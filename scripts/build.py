...
def _vscode_completion(g):
    ...
    header = """/** Generated by https://github.com/par-tec/d3fend-tools/blob/main/scripts/build.py */\n"""
    Path("docs/static/vscode-completion.js").write_text(header + js_text)
    logging.info("Generated vscode-completion.js")
